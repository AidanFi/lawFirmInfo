#!/usr/bin/env python3
"""Deep practice area re-scraping for 'General' entries with websites — Johnson County KS."""
...
PRACTICE_KEYWORDS = {
    "Personal Injury": [
        ...
        "pedestrian accident", "uber accident", "rideshare", "construction accident",
        "negligence claim", "traumatic brain", "tbi",
    ],
    "Family Law": [
    ...
    "Criminal Defense": [
        ...
        "felony", "misdemeanor", "drug charge", "drug offense", "assault charge",
        "theft charge", "burglary", "robbery", "homicide", "murder defense",
    ...
    "DUI": [
        ...
        "driving while intoxicated", "bui", "boating under influence",
    ],
    "Estate Planning": [
    ...
    "Business Law": [
        ...
        "business formation", "contract", "mergers and acquisitions", "m&a",
        "partnership", "llc formation", "corporate governance", "shareholder",
        "franchise law", "commercial transactions", "intellectual property",
    ...
    "Employment Law": [
        ...
        "non-compete", "employment contract", "severance",
    ],
    "Immigration": [
        "immigration", "visa", "green card", "citizenship", "naturalization",
        "deportation", "removal defense", "asylum", "work permit", "daca",
        "h-1b", "eb-5", "family immigration", "immigration attorney",
    ],
    "Bankruptcy": [
        "bankruptcy", "chapter 7", "chapter 11", "chapter 13", "debt relief",
        "debt discharge", "creditor", "debtor", "insolvency", "foreclosure defense",
        "wage garnishment", "repossession", "financial restructuring",
    ],
    "Real Estate": [
        "real estate law", "real estate attorney", "real estate lawyer",
        "property law", "closing attorney", "title insurance", "easement",
        "zoning", "land use", "landlord tenant", "commercial real estate",
        "residential real estate", "property dispute", "boundary dispute",
    ],
    "Social Security Disability": [
        "social security", "disability", "ssdi", "ssi", "supplemental security",
        "disability benefits", "disability claim", "disability appeal",
    ],
    "Medical Malpractice": [
        "medical malpractice", "medical negligence", "surgical error",
        "misdiagnosis", "birth injury", "hospital negligence", "nursing home abuse",
        "pharmaceutical", "defective drug", "healthcare liability",
    ],
    "Workers' Compensation": [
        "workers compensation", "workers' compensation", "work injury",
        "workplace injury", "work accident", "occupational injury",
    ...
    "Tax Law": [
        ...
        "tax dispute", "tax planning", "tax litigation", "estate tax",
...
for i, row in enumerate(targets, 1):
    ...
    pa = scrape_firm(website)
    if pa:
        # Find and update in rows list
        for r in rows:
...
print(f"\nFinal General PA: {general}/{total} ({general/total*100:.1f}%)")
